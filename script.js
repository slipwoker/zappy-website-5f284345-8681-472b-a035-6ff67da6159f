    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Yael Rubner Zimet משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '5f284345-8681-472b-a035-6ff67da6159f',
                    name: data.name || '',
                    email: data.email || '',
